...
func HomeWorkRespositary_IntoDB(apiCfg *config.ApiConfig, project students.Project) error {
	query := `
		INSERT INTO paddyproject(student_id, category, level, topic, description, bidAmount, deadline, update_at, requirement, discount_code )
...
func Return_Accepted_a_expert_already(api *config.ApiConfig, project_id int) (solutionexpert_model.ApplyForHomeWork, error) {
